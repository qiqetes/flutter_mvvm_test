...
final favouritesVMProvider =
    AutoDisposeNotifierProvider<FavouritesVM, List<Landmark>>.internal(
  FavouritesVM.new,
  name: r'favouritesVMProvider',
  debugGetCreateSourceHash:
      const bool.fromEnvironment('dart.vm.product') ? null : _$favouritesVMHash,
  dependencies: null,
  allTransitiveDependencies: null,
);

typedef _$FavouritesVM = AutoDisposeNotifier<List<Landmark>>;
